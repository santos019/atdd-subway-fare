...
public enum ErrorCode {
    ...
    SECTION_DURATION_TOO_SHORT(HttpStatus.BAD_REQUEST.value(), "SECTION_DISTANCE_TOO_SHORT", "구간의 시간은 최소 1 이상이어야 합니다."),
    ...
    SECTION_DURATION_LESS_THAN_EXISTING(HttpStatus.BAD_REQUEST.value(), "SECTION_DURATION_LESS_THAN_EXISTING", "새로운 구간의 시간은 기존의 구간 시간보다 길어야합니다."),
    ...
    SECTION_TYPE_NOT_FOUND(HttpStatus.BAD_REQUEST.value(), "SECTION_TYPE_NOT_FOUND", "구간의 타입을 찾을 수 없습니다."),
